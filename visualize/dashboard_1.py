...
def get_wifi_interface():
    """Find the Wi-Fi interface name on Windows"""
...
def start_packet_capture():
    ...
    if not interface:
        st.error("Wi-Fi interface not found! Please check your network settings.")
        return None
...
def main():
    ...
    st.set_page_config(page_title="Wi-Fi Traffic Analysis", layout="wide")
    st.title("Real-time Wi-Fi Network Traffic Analysis")
    ...
    # If no processor was initialized due to interface issues, stop execution
